yfrom dotenv import load_dotenv
...
🔰 ᴏᴡɴᴇʀ ᴄᴀɴ ʙʀᴏᴀᴅᴄᴀsᴛ ᴍᴇssᴀɢᴇ ᴛᴏ ᴀʟʟ ᴜsᴇʀs
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("👨‍💻Developer👨‍💻", url="https://t.me/ftmboz")],
                [
                    InlineKeyboardButton(
                        "🏘Source Code🏘", url="https://github.com/ftmdeveloper/MERGE-BOT"
                    ),
                    InlineKeyboardButton(
    ...
    try:
        with userBot:
            userBot.send_message(
                ...
                text="Bot booted with Premium Account,\n\n  Thanks for using <a href='https://github.com/ftmdeveloperz/merge-bot'>this repo</a>",
